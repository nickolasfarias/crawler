...
class Api::V1::QuotesController < ApplicationController
  ...
  def show
    #Primeiro eu checo se a tag já foi buscada, caso sim, eu não faço scraping e só leio as quotes que tem como primeira tag no array de tags a tag pesquisada
    if Quote.all.any? {|quote| quote.tags[0] == params[:tag]}
    ...
    #Caso a tag não tenha sido buscada, eu faço o scraping normalmente
      ...
      tags_by_div.each do |array|
        tag_index = array.find_index(params[:tag])
